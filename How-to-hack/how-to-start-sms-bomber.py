...
$ sudo python3 impulse.py --method SMS --threads 200 --time 9999999 --target number
...
$ sudo apt update
$ sudo apt install python3 python3-pip git make clang automake autoconf -y
$ sudo pip3 install db0mb3r
$ sudo db0mb3r
